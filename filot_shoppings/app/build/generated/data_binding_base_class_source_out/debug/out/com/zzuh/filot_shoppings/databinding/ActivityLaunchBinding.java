...
public final class ActivityLaunchBinding implements ViewBinding {
  ...
  private ActivityLaunchBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static ActivityLaunchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLaunchBinding((ConstraintLayout) rootView, imageView, progressBar,
          textView);
    }
